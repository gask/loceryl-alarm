...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSLog(@"notification: %@", [launchOptions objectForKey:UIApplicationLaunchOptionsLocalNotificationKey]);
...
- (void)application:(UIApplication *)application didReceiveLocalNotification:(UILocalNotification *)notification
{
    ...
    NSString *dateTimeString = [dateFormatter stringFromDate: notification.fireDate ];
    
    NSLog(@"recebi! recebi! eu recebi uma notificacao QUE LINDO :)))))) %@", dateTimeString);
}
